...
export function PricingSection() {
  const plans = [
    {
      name: "Старт",
      description: "Для небольших команд и отделов, начинающих автоматизацию.",
      price: "По запросу",
      duration: "в месяц",
      features: [
        "До 3 пользователей",
        "Автопроверка по ГОСТ",
        "Базовый нормоконтроль",
    ...
    {
      name: "Бизнес",
      description: "Для проектных организаций и инженерных департаментов.",
      price: "По запросу",
      duration: "в месяц",
      features: [
        "До 20 пользователей",
        "Полный нормоконтроль",
        "Поддержка ЕСКД и СПДС",
    ...
    {
      name: "Корпоратив",
      description: "Для крупных предприятий с индивидуальными требованиями.",
      price: "Индивидуально",
      duration: "",
      features: [
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-heading font-bold tracking-tighter sm:text-5xl">
                Тарифы под любой масштаб
              </h2>
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Выберите подходящий план или свяжитесь с нами — подберём решение под ваши задачи.
              </p>
            </div>
          </div>
        </ScrollReveal>
